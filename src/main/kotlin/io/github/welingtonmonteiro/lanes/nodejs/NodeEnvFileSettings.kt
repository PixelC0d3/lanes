 ...
 * conflicts, exactly like [io.github.welingtonmonteiro.lanes.RunConfigurationHelper.withEnvFile]).
 *
...
class NodeEnvFileSettings(profiles: List<String>, active: String) {
    ...
    companion object {
        ...
        const val SERIALIZATION_ID = "io.github.welingtonmonteiro.lanes.nodeEnvFiles"
