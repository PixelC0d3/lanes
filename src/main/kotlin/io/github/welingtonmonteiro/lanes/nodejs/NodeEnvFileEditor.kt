 ...
 * the Lanes group editor's env field: an editable combo holding every `.env` file used as a
    ...
    init {
        ...
        envFileCombo.toolTipText =
            "Active .env file (KEY=VALUE lines, # comments, optional \"export\" prefix), loaded when " +
                "this configuration runs - including a plain Play/Debug, not only through Lanes. " +
