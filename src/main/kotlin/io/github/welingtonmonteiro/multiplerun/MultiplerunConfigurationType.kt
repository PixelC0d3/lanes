...
class MultiplerunConfigurationType : ConfigurationTypeBase(
    ...
    init {
        addFactory(MultiplerunConfigurationFactory(this))
    }
     ...
     * that call could never reach `MultiplerunRunConfiguration.getIcon()` no matter what it returned,
     ...
     */
    private class MultiplerunConfigurationFactory(type: ConfigurationType) : ConfigurationFactory(type) {
        override fun createTemplateConfiguration(project: Project): RunConfiguration =
            MultiplerunRunConfiguration(project, this, "Multiple Run")
        ...
        // now on.
        override fun getId(): String = "Multiplerun"
    }
}
