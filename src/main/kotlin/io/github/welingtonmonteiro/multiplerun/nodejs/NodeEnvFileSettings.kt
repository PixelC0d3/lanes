...
/**
 * The Multiple Run env-file settings attached to a single Node-based run configuration (Node.js,
 ...
 *
 * Mirrors the environment model a Multiple Run *group* already offers its children, but for a
 ...
 * conflicts, exactly like [io.github.welingtonmonteiro.multiplerun.RunConfigurationHelper.withEnvFile]).
 *
...
class NodeEnvFileSettings(profiles: List<String>, active: String) {
    ...
    companion object {
        ...
        const val SERIALIZATION_ID = "io.github.welingtonmonteiro.multiplerun.nodeEnvFiles"

        private const val ATTR_ACTIVE = "active"
        private const val TAG_FILE = "file"

        @JvmField
        val KEY: Key<NodeEnvFileSettings> = Key.create("MultiplerunNodeEnvFileSettings")
