...
/**
 * Forces the platform to recompute the "configured" icon for every saved Multiple Run instance on
 ...
 * `MultiplerunRunConfiguration.getIcon()`.
 */
class MultiplerunConfiguredIconRefreshActivity : ProjectActivity {
    override suspend fun execute(project: Project) {
        ...
        for (settings in runManager.allSettings) {
            if (settings.configuration is MultiplerunRunConfiguration) {
